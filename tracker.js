...
(function () {
  ...
  controls.style = "margin-bottom:6px;display:flex;gap:5px;flex-wrap:wrap;justify-content:center";

  const info = document.createElement("div");
  info.id = "tracker-info";
  info.style = "text-align:center;margin:4px 0;font-size:11px;color:#0ff;";
  ...
  function render() {
    info.textContent = `Spin: ${sessionSpin}`;
    content.innerHTML = multipliers.map(m => {
      ...
      return `<div style="background:#2228;padding:6px;margin:4px 0;border-radius:10px;display:flex;align-items:center;justify-content:space-between;">
        <div style="display:flex;align-items:center;gap:4px;">
          <span>${badge}${rewatch} ${m.mult}x</span>
